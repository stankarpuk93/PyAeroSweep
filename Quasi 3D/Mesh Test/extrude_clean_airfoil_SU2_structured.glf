...
$_TMP(PW_2) setPhysicalType -usage CAE {Symmetry Plane}
...
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1) $_DM(1) $_DM(2) $_DM(3) $_DM(4) $_DM(5) $_DM(6) $_DM(7)]]]
