...
pw::Application markUndoLevel {Set Dimension 3D}
        ...
        def create_extrusion(self, update_glyph_data, Mesh):   
            Extrusion_direction = Mesh.update_glyph_data["Extrusion_direction"]
...
$_BL(1) setExtrusionSolverAttribute TranslateDirection {0}
