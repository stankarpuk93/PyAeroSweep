...
#from Test_Cases.Clean_airfoil_Full.Input_data  import Input_data
#from Test_Cases.Full_3D_wing.Case4.Input_data_3D_wing import Input_data_3D_wing
#from Methods import run_SU2
...
def run_aerodynamic_analysis(Input):
    ...
    # Run the airfoil generation script in a separate directory
    ...
    if Mesh.meshing is True:
        ...
        if  Solver.dimensions == '2d':
            ...
            if len(Geometry.Segments[0].TrailingEdgeDevice.PARSEC) != 0: 
    ...
    # Run CFD solution
    #Solver.run_solver(Freestream,Mesh,Geometry)
