...
def Input_data():
    ...
    case_output_dir_name = 'Flapped_airfoil_import_DAT_out'
...
#
    ...
    airfoil_file_path = r"/home/doktorand/Hiwi_Narunat/PyAeroSweep/Test_Cases_SU2/Flapped_airfoil/Test_Airfoil/NACA_24012.dat"
    ...
    segment.TrailingEdgeDevice.PARSEC = {
        ...
        "tc_shr_tip" : 0.004,                       # shroud tip thickness
