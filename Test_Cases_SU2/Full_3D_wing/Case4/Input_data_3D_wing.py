...
def Input_data_3D_wing():
    ...
    working_dir   = r"/home/doktorand/Software/PyAeroSweep-Stan-V3/PyAeroSweep/Test_Cases/Full_3D_wing/Case4" 
...
#
    ...
    Geometry_data.filename  = "Wing_geometry"
    Geometry_data.format    = 'igs'

    # Saves in igs by default
    # Can also save in Tecplot of VTK formats
    Geometry_data.output_format = "Tecplot"
    ...
    segment.Airfoil.files      = {
        "upper" : "main_airfoil_upper_3.dat",
        "lower" : "main_airfoil_lower_3.dat"
    }
    segment.Airfoil.PARSEC     = {
                                    "rle"        : 0.0084,                      # Main airfoil LE radius
                                    "x_pre"      : 0.458080577545180,           # x-location of the crest on the pressure side
    ...
    segment.leading_edge_sweep = 45 
    segment.Airfoil.files      = {
        "upper" : "main_airfoil_upper_4.dat",
        "lower" : "main_airfoil_lower_4.dat"
    }
    segment.Airfoil.PARSEC     = {
                                    "rle"        : 0.0084,                      # Main airfoil LE radius
                                    "x_pre"      : 0.458080577545180,           # x-location of the crest on the pressure side
...
#
    ...
    Mesh_data.global_surface_mesh_settings = {
            ...
            "Curvature resolution angle"  : 20,
            "Max aspect ratio"            : 100,
            "Refinement factor"           : 1.15,
            "Boundary gap subdivisions"   : 2             
        }

    Mesh_data.trailing_edge_meshing_settings = {
            "Trailing edge mapping"      : True,
