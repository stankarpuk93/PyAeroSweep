...
class WingMeshPreProcess():
    ...
    def write_glyph_file(self,working_dir,Geometry,Mesh,Solver,Inviscid_flag):
        ...
        ''' Write a glyph script to mesh a wing
        ...
        Inputs:
            ...
            Geometry            - Geometric settings
                ...
                Inviscid_flag   - flag to run viscous or inviscid meshing
        ...
        with open(working_dir + '/' + Mesh.glyph_file, 'w') as glyph_script:
            ...
            # Import the geometry
            # -------------------------------------------------------------------
            glyph_script.write(import_geometry(working_dir,Geometry.type,Geometry.filename,Geometry.format))
    ...
    def create_wing_surface_name(self,segment_index,quilt_num,count,fit_index):
        ''' Creates a set of names for surfaces of upper, lower, or 
            ...
            Inputs:
                segment_index - index of a wing segment in Pointwise
                quilt_num     - quilt number
                count          - database counter
                fit_index     - index for the geometry splining method (referef to pygeo)
    ...
    def export_mesh(self,working_dir,mesh_file,file):
        ''' Exports the mesh
            ...
            Inputs:
                ...
                mesh_file   - mesh output filename
                file        - glyph file
