...
def mesh_pre_process_2D(output_dir,Geometry,Mesh):
    ...
    if Mesh.structured is True:
        ...
        Mesh.update_glyph_data = {
            "upper_surface_filename"        : (output_dir + "/" + 'Geometry_files/' + Segment.Airfoil.files["upper"]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.Airfoil.files["upper"] + '"'),
            "lower_surface_filename"        : (output_dir + "/" + 'Geometry_files/' + Segment.Airfoil.files["lower"]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.Airfoil.files["lower"] + '"'),
            ...
            "su2meshed_file"                : output_dir + '/' + Mesh.filename,
            ...
            "meshed_file"                   : (output_dir + "/" + Mesh.filename) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Mesh.filename + '"'),  
        }
    ...
    #--------------------------------------------------------------------------------------------------------------
        ...
        Mesh.update_glyph_data = {
            "upper_surface_filename"        : (output_dir + "/" + 'Geometry_files/' + Segment.Airfoil.files["upper"]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.Airfoil.files["upper"] + '"'),
            "lower_surface_filename"        : (output_dir + "/" + 'Geometry_files/' + Segment.Airfoil.files["lower"]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.Airfoil.files["lower"] + '"'),
            "cut1_filename"                 : (output_dir + "/" + 'Geometry_files/' + Segment.TrailingEdgeDevice.files["flap cutout"][0]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.TrailingEdgeDevice.files["flap cutout"][0] + '"'),
            "cut2_filename"                 : (output_dir + "/" + 'Geometry_files/' + Segment.TrailingEdgeDevice.files["flap cutout"][1]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.TrailingEdgeDevice.files["flap cutout"][1] + '"'),
            "flap_airfoil_lower_filename"   : (output_dir + "/" + 'Geometry_files/' + Segment.TrailingEdgeDevice.files["lower surface file"]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.TrailingEdgeDevice.files["lower surface file"] + '"'),
            "flap_airfoil_upper_filename"   : (output_dir + "/" + 'Geometry_files/' + Segment.TrailingEdgeDevice.files["upper surface file"]) if Mesh.operating_system == "Unix" else ('"' + output_dir + "/" + Segment.TrailingEdgeDevice.files["upper surface file"] + '"'),
            "connector_dimensions"          : Mesh.airfoil_mesh_settings["connector dimensions"],
