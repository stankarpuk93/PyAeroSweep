...
set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic "G:/TUBS/HiWi/Dr Karpuk/PyAeroSweep-Stan-V2/PyAeroSweep-Stan-V2/main_airfoil_upper.dat"
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic "G:/TUBS/HiWi/Dr Karpuk/PyAeroSweep-Stan-V2/PyAeroSweep-Stan-V2/main_airfoil_lower.dat"
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic "G:/TUBS/HiWi/Dr Karpuk/PyAeroSweep-Stan-V2/PyAeroSweep-Stan-V2/main_airfoil_cut1.dat"
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic "G:/TUBS/HiWi/Dr Karpuk/PyAeroSweep-Stan-V2/PyAeroSweep-Stan-V2/main_airfoil_cut2.dat"
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic "G:/TUBS/HiWi/Dr Karpuk/PyAeroSweep-Stan-V2/PyAeroSweep-Stan-V2/flap_airfoil_lower.dat"
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic "G:/TUBS/HiWi/Dr Karpuk/PyAeroSweep-Stan-V2/PyAeroSweep-Stan-V2/flap_airfoil_upper.dat"
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end
...
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_DM(1) $_DM(2) $_DM(3)]]]
  $_TMP(mode_1) initialize -strict -type CAE "G:/TUBS/HiWi/Dr Karpuk/PyAeroSweep-Stan-V2/PyAeroSweep-Stan-V2/su2meshEx.su2"
