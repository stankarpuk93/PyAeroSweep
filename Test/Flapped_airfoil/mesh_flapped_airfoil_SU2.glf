...
set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic /home/doktorand/SE2A/HLFC_AeroOpt2D/Hi_Fi_CFD_HiLift/TestCase/main_airfoil_upper.dat
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic /home/doktorand/SE2A/HLFC_AeroOpt2D/Hi_Fi_CFD_HiLift/TestCase/main_airfoil_lower.dat
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic /home/doktorand/SE2A/HLFC_AeroOpt2D/Hi_Fi_CFD_HiLift/TestCase/main_airfoil_cut1.dat
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic /home/doktorand/SE2A/HLFC_AeroOpt2D/Hi_Fi_CFD_HiLift/TestCase/main_airfoil_cut2.dat
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic /home/doktorand/SE2A/HLFC_AeroOpt2D/Hi_Fi_CFD_HiLift/TestCase/flap_airfoil_lower.dat
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end

set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic /home/doktorand/SE2A/HLFC_AeroOpt2D/Hi_Fi_CFD_HiLift/TestCase/flap_airfoil_upper.dat
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end
...
set _TMP(mode_1) [pw::Application begin Modify [list $_CN(1) $_CN(2) $_CN(3) $_CN(4) $_CN(5) $_CN(6) $_CN(7) $_CN(8) $_CN(9) $_CN(10) $_CN(11) $_CN(12) $_CN(13) $_CN(14)]]
  pw::Entity transform [pwu::Transform scaling -anchor {0 0 0} {3 3 3}] [$_TMP(mode_1) getEntities]
$_TMP(mode_1) end
...
set _TMP(mode_1) [pw::Application begin UnstructuredSolver [list $_DM(1)]]
  ...
  $_TMP(PW_3) setValue 4.5854730054609229e-06
...
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_DM(1) $_DM(2) $_DM(3)]]]
  $_TMP(mode_1) initialize -strict -type CAE /home/doktorand/SE2A/HLFC_AeroOpt2D/Hi_Fi_CFD_HiLift/TestCase/su2meshEx.su2
