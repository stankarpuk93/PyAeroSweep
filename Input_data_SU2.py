...
Geometry.PARSEC_flap = {
        "cf_c"       : 0.0084,                      # flap chord ratio
        "ce_c"       : 0.458080577545180,           # conical curve extent ratio wrt the flap chord length
        "csr_c"      : -0.04553160030118,           # shroud chord ratio 
        "clip_ext"   : 0.554845554794938,           # shroud lip extent ratio wrt the flap  
        "r_le_flap"  : -9.649803736,                # flap leading edge radius
        "tc_shr_tip" : 0.46036604,                  # shroud tip thickness
        "w_conic"    : 0.06302395539,               # conical parameter for the suction side of the flap airfoil
...
Geometry.PARSEC_droop = {
        "delta_s"    : 20,              # droop nose deflection [deg]
        "cs_c"       :  0.25,           # droop nose chord ratio
